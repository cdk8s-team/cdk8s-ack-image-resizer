 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.57.0 (build f614666)", date = "2022-05-08T22:22:11.941Z")
@software.amazon.jsii.Jsii(module = imports.aws.k8s.services.lambda.$Module.class, fqn = "awsk8sserviceslambda.FunctionProps")
...
public interface FunctionProps extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.aws.k8s.services.lambda.FunctionSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<FunctionProps> {
        ...
        imports.aws.k8s.services.lambda.FunctionSpec spec;

        /**
         * Sets the value of {@link FunctionProps#getMetadata}
        ...
        /**
         * Sets the value of {@link FunctionProps#getSpec}
         * @param spec FunctionSpec defines the desired state of Function.
         * @return {@code this}
         */
        public Builder spec(imports.aws.k8s.services.lambda.FunctionSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements FunctionProps {
        ...
        private final imports.aws.k8s.services.lambda.FunctionSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.aws.k8s.services.lambda.FunctionSpec.class));
        }
        ...
        @Override
        public final imports.aws.k8s.services.lambda.FunctionSpec getSpec() {
            return this.spec;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("awsk8sserviceslambda.FunctionProps"));
