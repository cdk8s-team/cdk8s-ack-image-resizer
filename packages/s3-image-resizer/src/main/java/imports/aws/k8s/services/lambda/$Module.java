...
public final class $Module extends JsiiModule {
    ...
    private static Map<String, String> load() {
        ...
        try (final InputStream is = cl.getResourceAsStream("imports/aws/k8s/services/lambda/$Module.txt");
    ...
    public $Module() {
        super("awsk8sserviceslambda", "0.0.0", $Module.class, "awsk8sserviceslambda@0.0.0.jsii.tgz");
    }
